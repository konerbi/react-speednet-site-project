...
const Navbar = () => {
  ...
  function handleMenuItemClick(scrollTo) {
  ...
  return (
    <div className={`navigation ${isSticky ? "sticky" : ""} ${isInverted ? "inverted" : ""} ${isMobileMenuOpened ? "opened" : ""}`} id="navbar">
      <div className="navbar">
        <Link to="/" className="logo" title="Speednet Sp z o.o." onClick={() => handleMenuItemClick('navbar')}>
          <svg
          ...
          <ul className="menu ">
            {menuItems.map(((value, index) => {
              return value.isScrollLink ?
                <li key={'menu-item-' + index} className="item" onClick={() => handleMenuItemClick(value.scrollTo)}>
                  <div
                    title={t(value.title)}
                ...
                <li key={'menu-item-' + index} className="item">
                  <NavLink
                    ...
                    title={t(value.title)}
                    className="link"
                    onClick={() => handleMenuItemClick(value.scrollTo)}
                  >
                    {t(value.title)}
                  </NavLink>
                </li>
